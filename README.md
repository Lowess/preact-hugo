...
This boilerplate is based on [Victor-Hugo](https://github.com/netlify-templates/victor-hugo) but adapted for [Preact](https://github.com/preactjs/preact).

Preact-Hugo setup to use [PostCSS](http://postcss.org/) and [Babel](https://babeljs.io/) for CSS and JavaScript compiling/transpiling.
...
This will take some time and will install all packages necessary to run Hugo-Preact and its tasks.
